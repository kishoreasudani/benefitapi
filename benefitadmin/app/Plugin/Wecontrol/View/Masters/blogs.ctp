<section class="content content-custom">
    <div class="container-fluid">
        <div class="block-header relative">
            ...
            <?php echo $this->Html->link('Add Blog',array('controller'=>'masters','action'=>'add_blog'),array('class' => 'btn bg-orange waves-effect pull-right btn-right-position','escape'=>false)) ; 
            ?>          
        </div>   
...
$(document).ready(function(){
    ...
    $("#search_button").click(function() {
	    ...
	    var url = "<?php echo $this->Html->url(array('controller'=>'masters','action'=>'blogs_data'));?>"+'?q='+search_value;
	...
	function switchViewUrl(){
		...
		return url = adminUrl+'masters/blogs_data';	
