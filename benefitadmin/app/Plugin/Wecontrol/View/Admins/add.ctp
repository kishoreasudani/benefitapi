<section class="content">  
  <ol class="breadcrumb breadcrumb-col-teal">
      ...
      <li><?php  echo $this->Html->link('<i class="material-icons">person</i> Admins',array('controller'=>'admins','action'=>'index'),array('escape'=>false)) ; ?></li>        
      <li class="active"><i class="material-icons"></i>Add</li>
  </ol>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <?php echo $this->Form->create('Admin',array('url' => 'javascript:void(0)' , 'novalidate' => true,'id' => 'AdminAddForm', 'enctype' => "multipart/form-data")) ;?>                        
                <div class="row">
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                      <label for="email_address">Password<span class="red_star">*</span></label>
                      <div class="form-group">
                          <div class="form-line">
                            <?php echo $this->Form->password('Admin.password',array('placeholder' => 'Enter Password','class' => 'form-control')); ?>
                          </div>
                      </div>
                  </div>
                  <div class="col-md-6">
                      <label for="email_address">Confirm Password<span class="red_star">*</span></label>
                      <div class="form-group">
                          <div class="form-line">
...
$(document).ready(function(){
  ...
  //     var ajaxOptions = {
  //         url         : adminUrl+'admins/add/',
  //         resetForm   : false,
  //         dataType    : 'json',
  //         success     : ajaxSuccess
  //     };
  //     $( '#UserAddForm' ).ajaxForm( ajaxOptions );
  ...
  //                   setTimeout(function(){ window.location.href = adminUrl+'admins'; }, 500); 
  ...
  // });
   ...
   $(".jq_add").click( function() {
    ...
    $( '#AdminAddForm' ).ajaxForm( ajaxOptions );
    $( '#AdminAddForm' ).on('submit',function() {
      $("#loading_image").show();
    });
    function ajaxSuccess( data , responseCode , xhr ) {  
      $("#loading_image").hide();
