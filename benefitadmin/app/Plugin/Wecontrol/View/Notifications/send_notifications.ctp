...
<section class="content content-custom">  
    <ol class="breadcrumb breadcrumb-col-teal">
        ...
        <li class="active"><i class="material-icons">account_circle</i> Send Notification </li>
    </ol>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <?php echo $this->Form->text('UserNotification.message',array('placeholder' => 'Enter Message','class' => 'form-control')); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="email_address">Users</label>
                                                    <div class="form-group multiple-status-select">
                                                        <div class="form-line">
                                                            <?php echo $this->Form->select('UserNotification.receiver_id',$user_list,array('class' => 'form-control jq_status_list','multiple'=>true,'escape' => false,)); ?>
                                                        </div>
                                                    </div>
                                            </div>                
                                        </div>                                          
            ...
            callback: function(result) {  
                if(result == true) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: adminUrl+'notifications/send_notifications/',
                        data: frmData,
                        dataType: 'json',
                    error:function(a,b,c) {
                        ...
                        $("#loading_image2").hide();
                            if(data.success == false){
                                ...
                                setTimeout(function(){window.location.href = adminUrl+'notifications/'; }, 1000);                 
                            }
                        }
                    });
                }
