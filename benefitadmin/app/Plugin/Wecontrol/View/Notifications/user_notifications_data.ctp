            ...
            <table class="table table-bordered table-hover js-basic-example dataTable">
                <thead>
                    <tr>
                      ...
                      <th class="sortLink" width="25%"><?php echo $this->Paginator->sort('UserNotification.message','Message'); ?></th> 
                      <th class="sortLink" width="20%"><?php echo $this->Paginator->sort('UserNotification.sender','Sender'); ?></th>
                      <th class="sortLink" width="20%"><?php echo $this->Paginator->sort('UserNotification.read_status','Read Status'); ?></th> 
      ...
      callback: function(result) {  
        if(result == true) {
            ...
            $.ajax({
                type: "DELETE",
                async: true,
                url: adminUrl+'notifications/delete_user_notification',
