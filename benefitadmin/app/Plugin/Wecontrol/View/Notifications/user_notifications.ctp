<section class="content content-custom">
    <div class="container-fluid">
        <div class="block-header relative">
			...
			<?php   
			echo $this->Html->link('Add Notification',array('controller'=>'notifications','action'=>'add_notification'),array('class' => 'btn bg-orange waves-effect pull-right btn-right-position','escape'=>false)) ; 
            ?>         
        </div>   
...
$(document).ready(function(){
	...
	var url = adminUrl+'notifications/user_notifications_data';
    ...
    $("#search_button").click(function() {
	    ...
	    var url = "<?php echo $this->Html->url(array('controller'=>'notifications','action'=>'user_notification_data'));?>"+'?q='+search_value;
     	loadPiece(url,"#empdata");    
    });
	...
	$('#viewSwitch').click(function(){
		...
		if(switchTo == 'grid'){
			...
			var url = adminUrl+'notifications/user_notification_data';
		}else{
	...
	function switchViewUrl(){
		...
		return url = adminUrl+'notifications/user_notification_data';	
