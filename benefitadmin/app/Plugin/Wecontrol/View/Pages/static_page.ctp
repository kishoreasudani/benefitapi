	                     	...
	                     	<?php echo $this->Form->create('Search', array('url'=>'javascript:void(0)','id' => 'serachForm'));  ?>
                                <div class="col-sm-4">
                                    <div class="form-group no-margin-b	">
                                        <div class="form-line">
                                        <?php echo $this->Form->text('Search.title',array('class' => 'form-control', 'placeholder' => 'Name')); ?>                          
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function(){
	...
	var url = adminUrl+'pages/load_page';
    ...
    $("#search_button").click(function() {
	    ...
	    var url = "<?php echo $this->Html->url(array('controller'=>'pages','action'=>'load_page'));?>"+'?q='+search_value;
     	loadPiece(url,"#empdata");    
    });
	...
	function switchViewUrl(){
		...
		return url = adminUrl+'pages/load_page';	
