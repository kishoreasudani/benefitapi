    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
              ...
              <div class="body">
                    <?php 
                      echo $this->Form->create('Faq',array('url' => 'javascript:void(0)' , 'novalidate' => true,'id' => 'EditFaqForm')) ;
                ...
                <button type="submit" class="btn btn-primary m-t-15 waves-effect edit_product">Update</button>
...
$(document).ready(function(){
  ...
  $('.edit_product').click(function(){
    var frmData = $("#EditFaqForm").serialize(); 
    var id = $("#FaqId").val(); 
